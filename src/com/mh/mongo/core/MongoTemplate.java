...
import com.mh.mongo.util.Converter;
import com.mh.mongo.util.Pager;
...
public abstract class MongoTemplate {
	...
	public void addEntity(Serializable entity) {
		MongoCollection<Document> collection = getCollection();
		collection.insertOne(Converter.jsonStringToDocument(Converter.objectToJsonString(entity)));
	}
